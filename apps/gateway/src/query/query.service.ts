...
export class QueryService {
   ...
   */
  async getErrorDetail(identifier: string, appId?: string) {
  ...
  private mapBreadcrumb(row: { type: string; payload: Record<string, any>; ts: string }) {
