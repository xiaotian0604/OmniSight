    ...
    async resolveLocation(params) {
        ...
        try {
            ...
            const original = (0, trace_mapping_1.originalPositionFor)(traceMap, {
                line: params.lineno,
                column: typeof params.colno === 'number' && Number.isFinite(params.colno)
            ...
            const sourceContent = (0, trace_mapping_1.sourceContentFor)(traceMap, original.source);
            if (sourceContent) {
                resolved.sourceContext = this.extractSourceContext(sourceContent, original.line);
            }
        }
        catch (error) {
